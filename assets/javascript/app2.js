...
var myQuestions = [
 ...
 // 	console.log(trivia.question[1]);
 // 	console.log(trivia.correctAns);
 // 	console.log(trivia.selectAnswer.answer);
...
// 	for (i=0;i<trivia.selectAnswer.length;i++){
// 		console.log(trivia.ansSelect[i]);
// 	};
